...
In the last examples we combined the functionality of NDVI computation provided by this package with an in-situ database implemented at EURAC. This so called [MONALISA Database](monalisasos.eurac.edu/sos/index) holds NDVI measurements in 15-minute temporal resolution and can be accessed with a second [R-package](https://gitlab.inf.unibz.it/earth_observation_public/MonalisR) developed at EURAC Research.
